...
function spell_check(inp) {
  ...
  if (inp === '' || inp === ' ' || inp.length < 2) {
    alert('Bitte mehr Text schreiben!');
    return false;
  }

  if (inp.indexOf('[') !== -1 || inp.indexOf(']') !== -1 || inp.indexOf('{') !== -1 || inp.indexOf('}') !== -1 || inp.indexOf('<') !== -1 || inp.indexOf('>') !== -1 || inp.indexOf(';') !== -1 || inp.indexOf('array') !== -1 || inp.indexOf('return') !== -1 || inp.indexOf('eval') !== -1) {
    alert('Bitte keinen code einschreiben!');
    return false;
  }
...
var define_things = function() {
  ...
  function inscrit_users(us) {
    ...
    */
    ...
    var gone_users = highlighted_users_text.filter(function(obj) {
      return us.indexOf(obj) === -1;
    });
